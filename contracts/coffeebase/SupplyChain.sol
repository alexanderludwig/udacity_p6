...
contract SupplyChain is Ownable, RetailerRole, FarmerRole, DistributorRole, ConsumerRole {
    ...
    onlyFarmer 
  {
    ...
    item.productNotes = _productNotes;
     ...
     //= Item(sku, _upc, msg.sender, _originFarmerID, _originFarmName, _originFarmInformation, _originFarmLatitude, _originFarmLongitude, _productNotes);
