...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        assert.equal(resultBufferTwo[3], 0, 'Error: Invalid item State')
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        assert.equal(resultBufferOne[5], originFarmLatitude, 'Error: Missing or Invalid originFarmLatitude')
        assert.equal(resultBufferOne[6], originFarmLongitude, 'Error: Missing or Invalid originFarmLongitude')
        assert.equal(Number(resultBufferTwo[2]), productPrice, 'Error: Invalid productPrice')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        console.log(Number(farmerPostBalance))
        let productPriceTest = Number(farmerPostBalance) - Number(farmerPreBalance);
        ...
        assert.equal(resultBufferTwo[4], distributorID, 'Error: Invalid DistributorID')
        assert.equal(productPriceTest, productPrice, 'Error: Invalid Farmer eth');
        assert.equal(eventEmitted, true, 'Invalid event emitted')  
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[4], distributorID, 'Error: Invalid DistributorID')
        assert.equal(resultBufferTwo[5], retailerID, 'Error: Invalid DistributorID')
        assert.equal(eventEmitted, true, 'Invalid event emitted')  
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        assert.equal(resultBufferTwo[4], distributorID, 'Error: Invalid DistributorID')
        assert.equal(resultBufferTwo[5], retailerID, 'Error: Invalid Retailer')
        assert.equal(resultBufferTwo[6], consumerID, 'Error: Invalid Consumer')
